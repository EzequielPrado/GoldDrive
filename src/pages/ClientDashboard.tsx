...
const ClientDashboard = () => {
  ...
  return (
    <div className="h-screen w-full overflow-hidden bg-gray-100 font-sans text-slate-900 relative">
      ...
      {/* Main UI Layer */}
      <div className="absolute inset-0 z-30 pointer-events-none flex flex-col justify-end pb-32 md:justify-center p-4">
        {activeTab === 'home' && (
            <div className="w-full max-w-md mx-auto pointer-events-auto animate-in slide-in-from-bottom duration-500">
                {step === 'search' && (
                    <div className="bg-white/95 backdrop-blur-xl p-6 rounded-[32px] shadow-2xl border border-white/40">
                        ...
                        <Button className="w-full mt-6 h-14 text-lg font-bold rounded-2xl bg-black text-white hover:bg-zinc-800 shadow-xl transition-all" onClick={() => { if(!pickupLocation || !destLocation) showError("Selecione os endereços."); else setStep('confirm'); }}>
                ...
                {step === 'confirm' && (
                    <div className="bg-white/95 backdrop-blur-xl p-6 rounded-[32px] shadow-2xl border border-white/40 flex flex-col max-h-[70vh]">
        ...
        {activeTab === 'history' && (
            <div className="w-full max-w-md mx-auto bg-white/95 backdrop-blur-xl p-6 rounded-[32px] shadow-2xl border border-white/40 pointer-events-auto h-[60vh] flex flex-col">
